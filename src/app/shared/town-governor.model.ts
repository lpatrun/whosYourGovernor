export class TownGovernor {
  ...
  constructor(entityType: number, ID: number, name: string, countyID: number,
    countyName: string, address: string, zipCode: number, phone: string,
    fax: string, email: string, web: string, governor: string,
    viceGovernor: string, viceGovernor2: string, viceNationalMinority: string,
